...
#ifndef FRANKA_JOINT_TRAJECTORY_CONTROLLER__TRAJECTORY_HPP_
#define FRANKA_JOINT_TRAJECTORY_CONTROLLER__TRAJECTORY_HPP_

#include <memory>
#include <vector>

#include "franka_joint_trajectory_controller/interpolation_methods.hpp"
#include "franka_joint_trajectory_controller/visibility_control.h"
...
{
public:
  FRANKA_JOINT_TRAJECTORY_CONTROLLER_PUBLIC
  Trajectory();
...
#endif  // FRANKA_JOINT_TRAJECTORY_CONTROLLER__TRAJECTORY_HPP_
