...
#                   (default: franka.config.yaml in franka_launch/config)
#
...
# Example:
# ros2 launch franka_launch example.launch.py controller_name:=elbow_example_controller
#
...
# franka_launch/config directory. See that file for its own documentation.
#
